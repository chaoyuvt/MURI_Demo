...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
        source=ROOT / 'data/ae_generate',  # file/dir/URL/glob, 0 for webcam
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        ##########################################command here to remove boundry##################################
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / 'data/ae_generate', help='file/dir/URL/glob, 0 for webcam')
